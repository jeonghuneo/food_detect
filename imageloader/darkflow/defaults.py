class argHandler(dict):
    ...
    def setDefaults(self):
        ...
        self.define('model', '', 'configuration of choice')#change default
        ...
        self.define('load', '', 'how to initialize the net? Either from .weights or a checkpoint, or even from scratch')#change default
    ...
    def help(self):
        print('Example usage: flow --imgdir sample_img/  ')
        print('')
        print('Arguments:')
